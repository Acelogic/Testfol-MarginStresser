...
def analyze_wma(series, window=200, tolerance_weeks=0):
    """
...
def compare_wma_breach_events(portfolio_series, window=200, tolerance_weeks=2):
    """
    ...
    Uses the same methodology as compare_breach_events:
    - Breach Entry: entry at WMA breach date, exit at recovery
    - Max-Depth Entry: entry at lowest point, exit at recovery
    - Compares against SPYSIM for alpha calculation
    """
