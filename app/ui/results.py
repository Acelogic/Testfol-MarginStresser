...
def render(results, config, portfolio_name="", clip_start_date=None):
    ...
    res_tab_chart, res_tab_returns, res_tab_rebal, res_tab_tax, res_tab_xray, res_tab_mc, res_tab_debug = st.tabs(["📈 Chart", "📊 Returns Analysis", "⚖️ Rebalancing", "💸 Tax Analysis", "🔍 X-Ray", "🔮 Monte Carlo", "🔧 Debug"])
